    ...
    return (
      <div className="game">
        ...
        <div className="game-info">
          <div>{status}</div>
          <div>loc: row:{this.state.loc[0]} col:{this.state.loc[1]} des: row:{this.state.des[0]} col:{this.state.des[1]} red:{this.state.redpieces} blue:{this.state.bluepieces}</div>
        </div>
      </div>
    );
  }
